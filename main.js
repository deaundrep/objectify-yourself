...
newEmptySelf.firstName = 'DeAundre'

// Add a `lastName` property and set it to a string.
newEmptySelf.lastName = 'Prescott'
...
newEmptySelf.address.push('New Jersey')
newEmptySelf.address.push('New Brunswick')
newEmptySelf.address.push('The Park')
